...
/**
 * Icons inlined as SVG strings. Used as React components (the named
 * exports below) AND as raw markup via `ICON_SVG` for innerHTML
 * injection in the iframe hover toolbar.
 */
